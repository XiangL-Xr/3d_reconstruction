...
from .poses_utils import colmap_read_model as read_model
from .poses_utils.colmap_wrapper import run_colmap
from .preprocess.generate_mask import get_mask
from .preprocess.preprocess_cameras import get_normalization
...
def load_colmap_data(real_dir):
    ...
    # print('-- c2w shape: ', c2w_mats.shape)
    # print('-- c2w: ', c2w_mats)
