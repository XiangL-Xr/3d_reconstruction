...
class Dataset:
    def __init__(self, processed_data_dir):
        ...
        self.render_cameras_name = 'cameras.npz'
        self.object_cameras_name = 'cameras.npz'

        # self.camera_outside_sphere = conf.get_bool('camera_outside_sphere', default=True)
        # self.scale_mat_scale = conf.get_float('scale_mat_scale', default=1.1)
        self.camera_outside_sphere = True
        self.scale_mat_scale = 1.0
        ...
        self.masks_lis = sorted(glob(os.path.join(self.data_dir, 'masks/*.*')))
        ...
        #print('scale_mats', self.scale_mats_np)
    ...
    def gen_rays_at(self, img_idx, resolution_level=1):
        ...
        #print('pixels: ', pixels_x.shape, pixels_y.shape)
